...
class _StudentsListScreenState extends State<StudentsListScreen> {
  ...
  String getEnrollmentInfo(Student student) {
    if (student.enrollments.isEmpty) {
      return 'Not enrolled';
    }

    // Get class names from enrollments
    final enrolledClasses = student.enrolledClassNames;
    if (enrolledClasses.isEmpty) {
      return 'Not enrolled';
    }

    return enrolledClasses.join(', ');
  }
  ...
  Widget _buildStatusCard(String title, String count, Color color) {
    return Container(
      width: 160, // Fixed width for scrollable row
